...
To enable native HiDPI settings in the Display Preferences of macOS, download and run [the one-key-hidpi script](https://github.com/xzhih/one-key-hidpi) and select the option `(1) 1920x1080 Display`.
</details>
